...
public class Utility {
	...
	public static final String[] DELETE_WORDS=getDeleteWords();
	...
	private static String[] getDeleteWords(){
		File file=new File(controller.process.GotyaConst.dicPath+"dw.dct");
		...
		String[] deleteWords=filebuf.split("\n");
		return deleteWords;
	}
